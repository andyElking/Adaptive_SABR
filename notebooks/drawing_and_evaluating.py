from helpers import SDE, simple_batch_sde_solve, simple_sde_order
...
solvers_2_evals = ["Heun", "SORT", "ShOULD", "UBU3", "SRA1", "ShARK"]
...
def load_ref_sol_langevin(name):
    filename = f"data/ref_sol_{name}.npy"
    sol_x, sol_v = jnp.load(filename)
    return sol_x, sol_v
